...
requirements = python3,kivy,requests,pymongo==4.6.1,kivymd==1.1.1,python-firebase==1.2,multitasking==0.0.11,jsonschema==3.2.0,orjson==3.9.10,simplejson==3.17.6
