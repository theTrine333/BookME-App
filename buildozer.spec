...
requirements = python3==3.10.12,hostpython3==3.10.12,kivymd==1.1.1,kivy==2.2.1,kivyauth==2.3.3,requests,pyrebase,multitasking==0.0.11,jsonschema==3.2.0,orjson==3.9.10,simplejson==3.17.6
...
presplash.filename = %(source.dir)s/assets/icons/0.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/icons/0.png
